 ...
 * Protegida con la ANALYTICS_KEY guardada en localStorage
 * (se pide la primera vez, se guarda para la sesión).
 *
...
const UI = {
  es: {
    ...
    // KPIs
    kpiSessions:        '${t('kpiSessions')}',
    kpiUsers:           '${t('kpiUsers')}',
    kpiMapsGenerated:   '${t('kpiMapsGenerated')}',
    kpiMapsExported:    '${t('kpiMapsExported')}',
    kpiAvgLayers:       '${t('kpiAvgLayers')}',
    kpiAvgLayers2:      '${t('kpiAvgLayers2')}',
    kpiTimeToMap:       '${t('kpiTimeToMap')}',
    kpiTimeToMap2:      '${t('kpiTimeToMap2')}',
    kpiRefinements:     '${t('kpiRefinements')}',
    kpiRefinements2:    '${t('kpiRefinements2')}',
    kpiMessages:        '${t('kpiMessages')}',
    kpiRestAnon:        '${t('kpiRestAnon')}',
    kpiExportOf:        '${t('kpiExportOf')}',
    // Highlight
    mapsGenerated:      '${t('mapsGenerated')}',
    sessions:           'sesiones',
    registeredUsers:    'usuarios registrados',
    // Rate
    sessionToMapRate:   '${t('sessionToMapRate')}',
    // Charts
    chartMapsByDay:     t('chartMapsByDay'),
    chartSessionsByDay: t('chartSessionsByDay'),
    // Layers table
    noData:             'Sin datos',
    // Distribution
    distAnon:       t('distAnon'),
    distRegistered: t('distRegistered'),
    // Ops
    opClip:              t('opClip'),
    opClipExclude:       t('opClipExclude'),
    opIntersect:         t('opIntersect'),
    opIntersectExclude:  t('opIntersectExclude'),
    opBuffer:            t('opBuffer'),
    opBufferExclude:     t('opBufferExclude'),
    // Sources
    srcAr: t('srcAr'),
    srcUy: t('srcUy'),
    srcCl: t('srcCl'),
    // Button
    btnStatus:      '${t('btnStatus')}',
    // Computed at
