...
"op" and "clipArea"/"intersectArea"/"bufferArea" are optional — only include them when applicable (see operation and clip rules below). The most common case has no op or clipArea.
