...
window.I18N_EN = {
  ...
  validate_no_layer:                  'No layer selected.',
  validate_classify_no_field:         'You need to specify which field to classify by.',
  validate_classify_geom_none:        'This layer has no classifiable geometry.',
  validate_classify_too_many_cats:    'The field has more than {max} unique categories. Choose a field with fewer values.',
  validate_classify_too_few_values:   'The field has fewer than 2 unique values. Choose another field.',
  validate_no_classification:         'This layer has no active classification.',
  validate_no_filter:                 'This layer has no filterable fields defined.',
  validate_style_prop_not_valid:      '{param} is not available for {geom}.',
  validate_style_has_classification:  'This layer has an active classification. Keep it or replace with solid color?',
  validate_layer_not_found:           'That layer is not on the map.',
  validate_already_hidden:            'That layer is already hidden.',
  validate_already_visible:           'That layer is already visible.',
  validate_map_empty:                 'The map is already empty.',
