...
window.I18N_ES = {
  ...
  validate_no_layer:                  'No hay ninguna capa seleccionada.',
  validate_classify_no_field:         'Tenés que especificar por qué campo clasificar.',
  validate_classify_geom_none:        'Esta capa no tiene geometría clasificable.',
  validate_classify_too_many_cats:    'El campo tiene más de {max} categorías únicas. Elegí un campo con menos valores.',
  validate_classify_too_few_values:   'El campo tiene menos de 2 valores únicos. Elegí otro campo.',
  validate_no_classification:         'Esta capa no tiene clasificación activa.',
  validate_no_filter:                 'Esta capa no tiene campos filtrables definidos.',
  validate_style_prop_not_valid:      '{param} no está disponible para {geom}.',
  validate_style_has_classification:  'Esta capa tiene una clasificación activa. ¿Mantenés la clasificación o la reemplazás con color sólido?',
  validate_layer_not_found:           'No encontré esa capa en el mapa.',
  validate_already_hidden:            'Esa capa ya está oculta.',
  validate_already_visible:           'Esa capa ya está visible.',
  validate_map_empty:                 'El mapa ya está vacío.',
  validate_export_format_not_supported: 'El formato {formato} no está soportado. Podés exportar en: JPEG, PDF, GeoJSON o HTML.',
  validate_export_no_layers:          'No hay capas cargadas para exportar.',
  validate_basemap_invalid:           'Mapa de fondo no reconocido.',
  validate_layer_too_many_features:   '{titulo} tiene demasiados objetos ({n}) para mostrar sin recorte.',
  ...
  style_keep_classification_sub: 'Cambiar tamaño, grosor u otros parámetros',
  style_replace_classification: 'Reemplazar con color sólido',
  style_replace_classification_sub: 'Eliminará la clasificación actual',
  style_param_not_valid:     '{param} no está disponible para {geom}. Estos son los parámetros disponibles:',
  geom_point:                'puntos',
  geom_line:                 'líneas',
